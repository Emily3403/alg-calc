...
from alg_calc.colored import colored
from alg_calc.colored import cprint
from settings import config_file_location
...
def save_config(name, wert):
    ...
    with open(config_file_location, "r") as conf:
        std_config = json.load(conf)

    std_config[name] = wert
    with open(config_file_location, "w") as conf:
...
def load_config():
    ...
    if config_ is None:
        config_ = {
            "Nachkommastellen 1": 4,
            "Nachkommastellen 2": 5,
            "Nachkommastellen 3": 2,
            "Nachkommastellen Parser": 3,
            "Nachkommastellen Intern": 13,

            "Zwischenergebnis Farbe": "Violett",
            "Zwischenergebnis Zwischen Farbe": "Cyan",
            "Endergebnis Farbe": "Cyan",
            "Abschnitt Farbe": "Grün",
            "Menü Farbe": "Violett",
            "Error Farbe": "Rot",
            "Eingabe Farbe": "Gelb",
            ...
            "Gerade 1 Buchstabe": "j",
            "Gerade 1 Parameter": "r",

            "Gerade 2 Buchstabe": "s",
            "Gerade 2 Parameter": "h",

            "Ebene 1 Buchstabe": "F",
            "Ebene 1 Parameter 1": "u",
            "Ebene 1 Parameter 2": "v",

            "Ebene 2 Buchstabe": "Z",
            "Ebene 2 Parameter 1": "y",
            "Ebene 2 Parameter 2": "z",
            ...
            "Rechenweg Absvec": True,
            "Rechenweg Vektor zwei Punkte": True,
            "Rechenweg Normalenvektor": True,
            "Rechenweg Normaleneinheitsvektor": True,
            "Rechenweg Skalarprodukt": True,
            "Rechenweg Lineare Abhängigkeit": True,
            "Rechenweg Umrechnung zwischen Ebenengleichungen": True,
            ...
            "Rechenweg Gauss": True,

            "Lösungsweg Punktprobe Punkt Ebene": "koor",  # lgs, koor
            "Lösungsweg Schnitt Gerade Ebene": "koor",  # lgs, koor, passend
            "Lösungsweg Schnitt Ebene Ebene": "koor",  # lgs, koor, passend
            "Lösungsweg Abstand Punkt Gerade": "hilf",  # hilf, geo
            "Lösungsweg Abstand Punkt Ebene": "hnf",  # hnf, lfp
            "Lösungsweg Abstand Gerade Gerade parallel": "geo",  # hilf, geo
            "Lösungsweg Abstand Gerade Gerade windschief": "lfp",  # hnf, lfp
            "Lösungsweg Abstand Gerade Ebene": "lfp",  # hnf, lfp
